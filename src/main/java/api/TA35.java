...
public class TA35 extends INDEX_OBJECT implements IJsonData {
    ...
    protected void init_timeseries_handler() {
        ...
        timeSeriesHandler.put(Factories.TimeSeries.STOCKS_WEIGHTED_CHNGE_PROD, TimeSeriesFactory.get_serie(Factories.TimeSeries.STOCKS_WEIGHTED_CHNGE_PROD, this));
        ...
        timeSeriesHandler.put_id(Factories.TimeSeries.STOCKS_WEIGHTED_CHNGE_PROD,10126);
