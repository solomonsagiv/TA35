...
public class NewDataReaderService extends MyBaseService {
    ...
    // Cells
    String futureCell = "R4C14";
    String futureBidCell = "R4C13";
    String futureAskCell = "R4C15";

    String futureWeekBidCell = "R3C13";
    ...
    String lastCell = "R2C16";

    String openCell = "R2C17";
    String highCell = "R2C18";
