...
public class Index_BA_Delta_Month_Chart extends MyChartCreator {
	
	// Constructor
	public Index_BA_Delta_Month_Chart(ApiObject apiObject) {
		super(apiObject);
	}
	...
	public void createChart() throws CloneNotSupportedException {
		...
		// Index
		MyTimeSeries conBidAskCounter = new MyTimeSeries("ConBidAskCounter", Themes.BLUE, 1.5f, props,
		...
		// Index
		MyTimeSeries deltaSerie = new MyTimeSeries("Delta", Themes.LIGHT_BLUE_3, 1.5f, bottomChartProps,
		...
		// ----- Container ----- //
		MyChartContainer chartContainer = new MyChartContainer(charts, "Month BA Delta Chart");
