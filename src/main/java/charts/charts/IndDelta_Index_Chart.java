...
public class IndDelta_Index_Chart extends MyChartCreator {
	
	// Constructor
	public IndDelta_Index_Chart(ApiObject apiObject) {
		super(apiObject);
	}
	...
	public void createChart() throws CloneNotSupportedException {
		...
		// Index
		MyTimeSeries deltaSerie = new MyTimeSeries("Delta", Themes.RED_2, 1.5f, bottomChartProps,
		...
		// ----- Container ----- //
		MyChartContainer chartContainer = new MyChartContainer(charts, "Ind delta Chart");
