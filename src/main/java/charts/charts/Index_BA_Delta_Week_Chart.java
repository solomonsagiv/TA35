...
public class Index_BA_Delta_Week_Chart extends MyChartCreator {
	
	// Constructor
	public Index_BA_Delta_Week_Chart(ApiObject apiObject) {
		super(apiObject);
	}
	...
	public void createChart() throws CloneNotSupportedException {
		...
		// ----- Container ----- //
		MyChartContainer chartContainer = new MyChartContainer(charts, "Week BA Delta Chart");
