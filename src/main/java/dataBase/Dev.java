...
public class Dev implements IConnectionPool {

    // Singleton instance of the connection pool
    private static volatile Dev instance;
    ...
    private Dev() {
        ...
        config.setJdbcUrl("jdbc:postgresql://52.4.58.207:5432/jibe?ssl=true&sslmode=require"); // Replace with your JDBC URL
